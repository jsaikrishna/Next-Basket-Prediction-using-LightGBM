...
def runlgbm(prod,X_train, X_eval, y_train, y_eval):
    ...
    params = {'task': 'train', 'boosting_type': 'gbdt',   'objective': 'binary', 'metric': {'binary_logloss', 'auc'},
        'num_iterations' : 1000, 'max_bin' : 100,  'feature_fraction': 0.8,  
        'bagging_freq': 5, 'bagging_fraction': 0.95, 'min_data_in_leaf' : 200, 'num_leaves': 512, 'learning_rate' : 0.05}
    ...
    for threshold in [0.16, 0.20, 0.26]:
