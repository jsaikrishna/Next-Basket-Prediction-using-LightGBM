...
def format_data(data):
    ...
    data = data.astype(dtype= {'user_id' : np.int32, 'product_id'  : np.int16,'user_porder'  : np.int8, 'user_pforder' : np.int8, 'user_lforder' : np.int8,'user_pavg_pos' : np.int8, 'prod_orders' : np.int16,'prod_reorder_prob' : np.float16,'prod_reorder_ratio' : np.float16, 'user_orders' : np.int32,'user_period' : np.int8, 'user_md' : np.int8,'user_tp' : np.int8, 'user_reorder_ratio' : np.float16,'user_dp' : np.int8, 'user_bsize' : np.int8,'order_id'  : np.int32, 'eval_set' : np.int8,'days_since_prior_order' : np.int8, 'user_po_rate' : np.float16,'up_orders_since_last_order':np.int8,'aisle_id': np.int8, 'department_id': np.int8})
